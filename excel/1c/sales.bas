...
'****************************************************************************************************************************************
Public Sub SalesProductService(strPath, strUser, strPassword, strOrganization, strDateStart, strDateFinish, shData)
...
strText = "SELECT ХозрасчетныйДвиженияССубконто.Период, ХозрасчетныйДвиженияССубконто.Регистратор,ХозрасчетныйДвиженияССубконто.СубконтоДт1,ХозрасчетныйДвиженияССубконто.СубконтоДт2,ХозрасчетныйДвиженияССубконто.СубконтоКт1,ХозрасчетныйДвиженияССубконто.СубконтоКт2,ХозрасчетныйДвиженияССубконто.СубконтоКт3, ХозрасчетныйДвиженияССубконто.КоличествоКт,ХозрасчетныйДвиженияССубконто.Сумма " & vbNewLine & _
...
Set objАccount1 = objFileDb.ПланыСчетов.Хозрасчетный.НайтиПоКоду("62.01")
objQuery.SetParameter "СчетДт", objАccount1
Set objАccount2 = objFileDb.ПланыСчетов.Хозрасчетный.НайтиПоКоду("90.01.1")
...
Do While objResult.Next()
    ...
    With shData
        ...
        .Cells(lStart, 4).Value = objFileDb.String(objResult.СубконтоДт2)
        ...
        .Cells(lStart, 8).Value = CLng(objFileDb.String(objResult.КоличествоКт))
